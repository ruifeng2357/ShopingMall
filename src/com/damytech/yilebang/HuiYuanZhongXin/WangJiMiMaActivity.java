 ...
 */
public class WangJiMiMaActivity extends MyActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.huiyuanzhongxin_wangjimima);
    ...
    private void getControlVariables () {
        ...
        m_txtBindedPhone = (EditText) findViewById(R.id.txtBindedPhone);
        ...
        m_txtGetCaptcha.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (GlobalData.isValidPhone(m_szBindedPhone))
                {
                    callRequestVerifyKey ();
                }
                else
                {
                    GlobalData.showToast(WangJiMiMaActivity.this, getString(R.string.MSG_Invalid_PhoneNum));
                    return;
                }
            }
        });
    ...
    private void goToSecondStep () {
        ...
        if ( m_szBindedPhone.isEmpty() ) {
            GlobalData.showToast(WangJiMiMaActivity.this, getString(R.string.HuiYuanZhongXin_XiuGaiMiMa_Msg_PhoneNoShouldNotBeEmpty));
            return;
        }

        if ( m_szCaptcha.isEmpty() ) {
            GlobalData.showToast(WangJiMiMaActivity.this, getString(R.string.HuiYuanZhongXin_XiuGaiMiMa_Msg_CaptchaShouldNotBeEmpty));
            return;
        }
    ...
    private void submit () {
        ...
        if ( m_szNewPassword.isEmpty() ) {
            GlobalData.showToast(WangJiMiMaActivity.this, getString(R.string.HuiYuanZhongXin_XiuGaiMiMa_Msg_PasswordShouldNotBeEmpty));
            return;
        }

        if ( !m_szNewPassword.equals(m_szConfirmPassword) ) {
            GlobalData.showToast(WangJiMiMaActivity.this, getString(R.string.HuiYuanZhongXin_XiuGaiMiMa_Msg_PasswordMismatch));
            return;
        }
    ...
    private void callResetPassword () {
        handler = new JsonHttpResponseHandler()
        {
            ...
            public void onSuccess(JSONObject object)
            {
                ...
                GlobalData.showToast(WangJiMiMaActivity.this, retMsg);
            }
            ...
            public void onFinish()
            {
                ...
                {
                    GlobalData.showToast(WangJiMiMaActivity.this, getString(R.string.server_connection_error));
                }
